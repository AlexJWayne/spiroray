...
flags="-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -sTOTAL_STACK=32mb --shell-file source/main_web/index_template.html --preload-file assets"
