...
// include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmphwgmh4is.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/.DS_Store", "start": 0, "end": 6148}, {"filename": "/assets/style_dark.rgs", "start": 6148, "end": 9873}], "remote_package_size": 9873});

  })();

// end include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmphwgmh4is.js
// include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmp1zqz6c4q.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmp1zqz6c4q.js
// include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmpklosrem8.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/3x/55vlchg927v8tbgy74pv1nkr0000gn/T/tmpklosrem8.js
...
var ASM_CONSTS = {
  33777112: () => { if (document.fullscreenElement) return 1; },  
 33777158: () => { return document.getElementById('canvas').width; },  
 33777210: () => { return parseInt(document.getElementById('canvas').style.width); },  
 33777278: () => { document.exitFullscreen(); },  
 33777305: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 33777378: () => { if (document.fullscreenElement) return 1; },  
 33777424: () => { return document.getElementById('canvas').width; },  
 33777476: () => { return screen.width; },  
 33777501: () => { document.exitFullscreen(); },  
 33777528: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 33777661: () => { return window.innerWidth; },  
 33777687: () => { return window.innerHeight; },  
 33777714: () => { if (document.fullscreenElement) return 1; },  
 33777760: () => { return document.getElementById('canvas').width; },  
 33777812: () => { return parseInt(document.getElementById('canvas').style.width); },  
 33777880: () => { if (document.fullscreenElement) return 1; },  
 33777926: () => { return document.getElementById('canvas').width; },  
 33777978: () => { return screen.width; },  
 33778003: () => { return window.innerWidth; },  
 33778029: () => { return window.innerHeight; },  
 33778056: () => { if (document.fullscreenElement) return 1; },  
 33778102: () => { return document.getElementById('canvas').width; },  
 33778154: () => { return screen.width; },  
 33778179: () => { document.exitFullscreen(); },  
 33778206: () => { if (document.fullscreenElement) return 1; },  
 33778252: () => { return document.getElementById('canvas').width; },  
 33778304: () => { return parseInt(document.getElementById('canvas').style.width); },  
 33778372: () => { document.exitFullscreen(); },  
 33778399: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 33778457: () => { return screen.width; },  
 33778482: () => { return screen.height; },  
 33778508: () => { return window.screenX; },  
 33778535: () => { return window.screenY; },  
 33778562: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 33778615: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 33778686: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 33778743: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 33778999: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 33779070: () => { if (document.fullscreenElement) return 1; },  
 33779116: () => { return window.innerWidth; },  
 33779142: () => { return window.innerHeight; },  
 33779169: () => { if (document.pointerLockElement) return 1; }
};
